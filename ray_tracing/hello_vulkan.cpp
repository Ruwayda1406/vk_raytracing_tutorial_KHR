...
//
void HelloVulkan::updateCameraMatUniformBuffer()
{
...
void HelloVulkan::initRayTracing() {
  ...
  auto properties = m_physicalDevice.getProperties2<vk::PhysicalDeviceProperties2, vk::PhysicalDeviceRayTracingPropertiesKHR>();
